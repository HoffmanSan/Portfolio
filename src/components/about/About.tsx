  ...
  return (
    <section id="about">
      <div className="about-content" >
        <AnimationWrapper hidden={{ opacity: 0, scale: 0.5 }} visible={{ opacity: 1, scale: 1 }} transition={{ duration: 0.75, delay: 0.25 }}>
        ...
        <div className="personal-info">
          ...
          <AnimationWrapper hidden={{ opacity: 0, scale: 0.5 }} visible={{ opacity: 1, scale: 1 }} transition={{ duration: 0.75, delay: 0.25 }} style={{ width: '100%', height: '100%' }}>
            <div className="bar-container">
              <Bar tag='HTML' progress={90} delay={1000}/>
              <Bar tag='CSS' progress={90} delay={1100}/>
              <Bar tag='JavaScript' progress={90} delay={1200}/>
              <Bar tag='React' progress={90} delay={1300}/>
              <Bar tag='Node' progress={70} delay={1400}/>
              <Bar tag='MongoDB' progress={50} delay={1500}/>
              <Bar tag='PostgreSQL' progress={50} delay={1600}/>
              <Bar tag='Firebase' progress={50} delay={1700}/>
            </div>
          </AnimationWrapper>
        </div>
